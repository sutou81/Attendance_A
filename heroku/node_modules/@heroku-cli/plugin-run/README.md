...
@heroku-cli/plugin-run/7.42.5 darwin-x64 node-v10.18.1
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/logs.ts](https://github.com/heroku/cli/blob/v7.42.5/src/commands/logs.ts)_
...
_See code: [src/commands/run/index.ts](https://github.com/heroku/cli/blob/v7.42.5/src/commands/run/index.ts)_
...
_See code: [src/commands/run/detached.ts](https://github.com/heroku/cli/blob/v7.42.5/src/commands/run/detached.ts)_
...
_See code: [src/commands/run/inside.ts](https://github.com/heroku/cli/blob/v7.42.5/src/commands/run/inside.ts)_
<!-- commandsstop -->
