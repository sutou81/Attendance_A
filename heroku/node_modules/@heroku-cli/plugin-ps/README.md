...
_See code: [src/commands/ps/autoscale/disable.ts](https://github.com/heroku/cli/blob/v7.39.3/packages/ps/src/commands/ps/autoscale/disable.ts)_
...
_See code: [src/commands/ps/autoscale/enable.ts](https://github.com/heroku/cli/blob/v7.39.3/packages/ps/src/commands/ps/autoscale/enable.ts)_
...
_See code: [src/commands/ps/wait.ts](https://github.com/heroku/cli/blob/v7.39.3/packages/ps/src/commands/ps/wait.ts)_
...
_See code: [src/commands/regions.ts](https://github.com/heroku/cli/blob/v7.39.3/packages/ps/src/commands/regions.ts)_
<!-- commandsstop -->
