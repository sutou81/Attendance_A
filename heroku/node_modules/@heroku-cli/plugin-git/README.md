...
@heroku-cli/plugin-git/7.41.0 darwin-x64 node-v10.18.1
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.41.0/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.41.0/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
